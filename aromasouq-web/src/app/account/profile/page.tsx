          ...
          <div className="p-8 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <label className="text-sm text-gray-600 block">Language</label>
                  <p className="font-medium text-gray-900">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <label className="text-sm text-gray-600 block">Coins Balance</label>
                  <p className="font-medium text-gray-900">{profile.coinsBalance} coins</p>
                  <p className="text-xs text-gray-500 mt-1">
                    = AED {profile.coinsBalance.toFixed(2)} value
                  </p>
                </div>
              </div>
            </div>
