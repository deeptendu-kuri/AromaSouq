      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg shadow-lg p-8 text-white mb-8">
          ...
          <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-yellow-300">
            ...
            <div>
              <p className="text-yellow-100 text-sm">Lifetime Spent</p>
        ...
        {/* Ways to Earn Coins */}
        <div className="mt-8">
          <h2 className="text-2xl font-bold mb-6">Ways to Earn Coins</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white border-2 border-purple-200 rounded-lg p-6 hover:shadow-lg transition">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Every Purchase</h3>
              <p className="text-sm text-gray-600 mb-3">
                Earn 10% of your order value as coins on every purchase
              </p>
              <div className="text-2xl font-bold text-purple-600">10%</div>
              <p className="text-xs text-gray-500 mt-1">of order value</p>
            </div>
            ...
            <div className="bg-white border-2 border-yellow-200 rounded-lg p-6 hover:shadow-lg transition">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Share your experience and earn bonus coins for each review
              </p>
              <div className="text-2xl font-bold text-yellow-600">+Coins</div>
              <p className="text-xs text-gray-500 mt-1">per review</p>
            </div>
            ...
            <div className="bg-white border-2 border-pink-200 rounded-lg p-6 hover:shadow-lg transition">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Participate in special promotions and seasonal campaigns
              </p>
              <div className="text-2xl font-bold text-pink-600">Bonus</div>
              <p className="text-xs text-gray-500 mt-1">limited time</p>
            </div>
            ...
            <div className="bg-white border-2 border-blue-200 rounded-lg p-6 hover:shadow-lg transition">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Special Rewards</h3>
              <p className="text-sm text-gray-600 mb-3">
                Exclusive rewards for loyal customers and special achievements
              </p>
              <div className="text-2xl font-bold text-blue-600">Surprise</div>
        ...
        <div className="mt-8 bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200 rounded-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">How to Use Your Coins?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">1 Coin = 1 AED</p>
                <p className="text-sm text-gray-600">Each coin is worth 1 AED discount</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="font-medium text-gray-900">Use at Checkout</p>
                <p className="text-sm text-gray-600">Apply coins when placing your order</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="font-medium text-gray-900">Up to 50% Off</p>
                <p className="text-sm text-gray-600">Use coins for up to 50% of order value</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="font-medium text-gray-900">No Expiration</p>
                <p className="text-sm text-gray-600">Coins don't expire unless specified</p>
              </div>
            </div>
          </div>
        </div>
