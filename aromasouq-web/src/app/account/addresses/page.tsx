      ...
      {addresses && addresses.length > 0 ? (
        ...
        <div className="bg-white rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto">
            You haven't added any shipping addresses yet. Add your first address to make checkout faster and easier.
          </p>
          <Link
            href="/account/addresses/new"
      ...
      {addresses && addresses.length > 0 && (
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            <strong>Note:</strong> Your default address will be automatically selected during checkout. You can change it anytime by clicking "Set as Default" on any address.
          </p>
        </div>
      )}
    </div>
