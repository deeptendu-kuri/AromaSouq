    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Create and manage discount coupons for your products</p>
        </div>
        {!showForm && (
          <button
      ...
      {coupons && coupons.length > 0 ? (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {!coupon.isActive && (
                        <span className="px-2 py-1 bg-gray-200 text-gray-700 text-xs font-semibold rounded">Inactive</span>
                      )}
                      {expired && (
                        <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded">Expired</span>
                      )}
                      {upcoming && (
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded">Upcoming</span>
                      )}
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 mb-4">
                  ...
                  {coupon.minOrderAmount && (
                    <p className="text-sm text-gray-600 mt-1">Min. order: {coupon.minOrderAmount} AED</p>
                  )}
                  {coupon.maxDiscount && (
                    <p className="text-sm text-gray-600">Max. discount: {coupon.maxDiscount} AED</p>
                  )}
                </div>
        ...
        <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">Create your first coupon to offer discounts to your customers.</p>
          {!showForm && (
            <button
              onClick={() => setShowForm(true)}
